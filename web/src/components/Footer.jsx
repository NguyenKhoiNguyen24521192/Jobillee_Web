...
function Footer() {
  return (
    <footer className="bg-[rgb(var(--jobillee-red))] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Left Column - Company Info */}
          <div>
            <div className="flex items-center gap-3 mb-6">
              <JobilleeLogo className="h-16 w-16" color="white" />
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <a href="mailto:info@jobillee.vn" className="hover:underline">
                  info@jobillee.vn
                </a>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                ...
                <div className="flex flex-col gap-2">
                  <a 
                    href="#" 
                    className="inline-block bg-white text-[rgb(var(--jobillee-dark))] px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-all duration-200 active:scale-95"
                  >
                    Google Play
                  </a>
                  <a 
        ...
        <div className="border-t border-white/20 mt-8 pt-6 text-center text-sm opacity-90">
          <p>© 2026 Jobillee Việt Nam. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
